...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendors/css/adminlte.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendors/bootstrap4-duallistbox/bootstrap-duallistbox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/bs-stepper/css/bs-stepper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/dropzone/min/dropzone.min.css') }}">
