        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Input Data Pendonor </h3>
                            ...
                            <div class="card-body">
                                <form action="{{ route('pendonor.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputName1" name="nohp">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputName1" name="beratbadan">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputName1" name="kadarhb">
                                    </div>
                                    <div class="form-group">
