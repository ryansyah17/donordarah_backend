                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-success" href="{{ route('member.create') }}"> Tambah</a>
                                </p>
                                        ...
                                        <tbody>
                                            @foreach ($member as $m)
                                                <tr>
                                                    ...
                                                    <td>{{ ++$i }}</td>
                                                    <td>{{ $m->name }}</td>
                                                    <td class="text-capitalize">{{ $m->jenis_kelamin }}</td>
                                                    <td class="text-capitalize">{{ $m->roles }}</td>
                                                    <td>{{ $m->goldarah }}</td>
                                                    <td>
                                                        <form action="{{ route('member.destroy', $m->id) }}" method="POST">
                                                            <a class="btn btn-warning" href="{{ route('member.edit', $m->id) }}"
